<template>
  <div class="app-container">
    <el-form :model="queryParam"
             ...
             :inline="true">
      <el-form-item>
        <router-link :to="{path:'/classes/create'}"
                     class="link-left">
    ...
    <el-table v-loading="listLoading"
      ...
      <el-table-column width="220px"
        ...
        <template slot-scope="{row}">
          <router-link :to="{path:'/classes/edit', query:{id:row.id}}"
                       class="link-left">
...
export default {
  ...
  methods: {
    async search() {
      ...
      await classesApi.list(this.queryParam).then(({ data }) => {
